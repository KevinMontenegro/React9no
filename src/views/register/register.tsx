...
import { View, Text, Image, TextInput,ToastAndroid, StyleSheet, TouchableOpacityBase, TouchableOpacity } from "react-native";
...
const styles = StyleSheet.create({
    ...
    textFormInput: {
      ...
      borderBottomColor: MisColores.secondary,
